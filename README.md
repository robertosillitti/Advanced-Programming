...
It contains materials and Python implementations developed for the Advanced Programming course of the MSc in Data Analytics for Business at Cattolica University, covering algorithms, data structures (DLL, Stacks and Queues, Trees, Hash tables and Graphs), advanced programming techniques, and combining both theoretical foundations and practical Python applications.
...
Implementation of Merge Sort, Binary Search, Selection Sort, Quick Sort and Randomized Quick Sort, Bubble Sort. 
